...
<section class="content">
  <div class="container">
    <h1>JajananBabel | Oleh-oleh Khas Kepulauan Bangka Belitung</a>
    </h1>
    <div class="row">
      <?php
      ...
      <div class="col-md-3">
        <div class="thumbnail">
          ...
          <div class="caption">
            ...
            <a href="detail.php?id=<?= $perproduk['id_produk']; ?>" class="btn btn-default">DETAIL PRODUK</a>
          </div>
        </div>
      </div>
      <?php endwhile; ?>
