...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Mar 2022 pada 08.40
...
(22, 7, '2022-03-27', 47000, 'Jalan Teladan AMD', 'pending', '', 550, 'Indonesia', 'Kab. Bangka Selatan', '', '', 'pos', '', 0, ''),
(23, 7, '2022-03-27', 71000, 'Jalan Teladan AMD', 'pending', '', 500, 'Bangka Belitung', 'Bangka Selatan', 'Kabupaten', '33719', 'tiki', 'ECO', 46000, '4');
...
(30, 22, 4, 1, 'Permen Kabung', 15000, 200, 200, 15000),
(31, 22, 8, 1, 'Kopi Bubuk Cap 1 Roasted', 32000, 350, 350, 32000),
(32, 23, 3, 1, 'Bong Li Piang', 25000, 500, 500, 25000);
...
(1, 1, 'Kue Rintak', 20000, 300, 'kuerintak.jpg', 'Rintak adalah salah satu cookies tradisional Bangka yang terbuat dari Sagu Rumbia. Rasa nya yang manis dan kombinasi renyah saat digigit dan meleleh di mulut membuat cookies tradisional satu ini paling pas jika dinikmati bersama dengan kopi pahit.\r\n\r\nUntuk membedakan rintak yang berkualitas adalah saat digigit. Rintak berkualitas renyah di luar nya namun tidak keras saat digigit, Di di dalam nya agak sedikit lembut tidak terlalu garing seperti di luar nya.', 196),
(2, 2, 'Teh Tayu', 21000, 50, 'tehtayu.jpg', 'Teh Khas Bangka.\r\n\r\nJika membayangkan kebun teh, kita umumnya terbayang dengan kebun teh yang ada di daerah dataran tinggi yang dingin dan berkabut. Namun ada satu yang unik di Bangka, tepatnya di kecamatan Jebus (Nampong), dusun Tayu . Ada warisan teh dataran rendah yang memiliki rasa yang kuat, khas dan unik. Teh dengan aroma hasil sangrai yang kuat meninggalkan kesan yang tak terlupakan dan berbeda dari teh pada umumnya. Teh Tayu ini dipercaya mengandung banyak khasiat yang baik bagi tubuh, seperti mencegah kolesterol, menstabilkan gula darah dan tekanan darah tinggi.', 198),
